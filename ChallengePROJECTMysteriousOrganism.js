...
function twoMostRelatedpAequor(thirtyObjectsArray) {
    ...
    return `The two most related instances of pAequor are specimen ${arrayToBeSorted[0][0]} and specimen ${arrayToBeSorted[0][1]} with 
    having ${arrayToBeSorted[0][2]}% DNA in common!`;
}
